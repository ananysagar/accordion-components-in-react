...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "React manages state using the useState hook for local state and Context API, Redux, or Recoil for global state management.",
  },
  {
    id: 3,
    question: "What is JSX?",
    answer:
      "JSX is a syntax extension for JavaScript that allows you to write HTML-like code inside JavaScript files. It makes React component rendering easier.",
  },
  {
    id: 4,
  ...
  },
  {
    ...
    answer:
      "React's virtual DOM is a lightweight copy of the actual DOM. When changes occur, React updates only the necessary parts of the real DOM, improving performance.",
  },
  {
    id: 7,
    question: "What is the purpose of useEffect?",
    answer:
      "useEffect is a React hook used to handle side effects such as fetching data, updating the DOM, or subscribing to events in function components.",
  },
  {
    id: 8,
    question: "What are React fragments?",
    answer:
      "React fragments allow you to group multiple elements without adding an extra parent node to the DOM, improving performance and structure.",
  },
];
